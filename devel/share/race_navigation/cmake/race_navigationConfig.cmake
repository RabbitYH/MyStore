...
if("TRUE" STREQUAL "TRUE")
  set(race_navigation_SOURCE_PREFIX /home/caoyonghao/catkin_ws/src/race_navigation)
  set(race_navigation_DEVEL_PREFIX /home/caoyonghao/catkin_ws/devel)
  ...
  set(race_navigation_INSTALL_PREFIX /home/caoyonghao/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'race_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caoyonghao/catkin_ws/src/race_navigation/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND race_navigation_EXPORTED_TARGETS ${${race_navigation_dep}_EXPORTED_TARGETS})
endforeach()
